...
- [`9fb0396`](https://github.com/elliotBraem/better-near-auth/commit/9fb03967a25d580fb939385c43b0c482a1da2917) Thanks [@elliotBraem](https://github.com/elliotBraem)! - fix: secure relayer config validation, eager boot init, and clear error reporting
...
- [#73](https://github.com/elliotBraem/better-near-auth/pull/73) [`4ea5aad`](https://github.com/elliotBraem/better-near-auth/commit/4ea5aade0743d989c4a7351f2b3215780d299cc0) Thanks [@elliotBraem](https://github.com/elliotBraem)! - feat: collapse relayer config into a single shape with per-network secrets
...
- [`8f08d21`](https://github.com/elliotBraem/better-near-auth/commit/8f08d216a7b80a54c4a9af0f432621bd0943f460) Thanks [@elliotBraem](https://github.com/elliotBraem)! - feat: redesign relayer configuration with true shorthand and per-network support
...
- [#64](https://github.com/elliotBraem/better-near-auth/pull/64) [`31a154e`](https://github.com/elliotBraem/better-near-auth/commit/31a154e90e00d1384c467f84bb7e41a8591373a1) Thanks [@elliotBraem](https://github.com/elliotBraem)! - fix: replace client: NearType with getNearClient() to fix better-auth type inference
...
- [`e29d2e0`](https://github.com/elliotBraem/better-near-auth/commit/e29d2e086d27c08c1a3a7b0dbe1891459968993e) Thanks [@elliotBraem](https://github.com/elliotBraem)! - Client methods `createSubAccount`, `getRelayerInfo`, and `checkSubAccountAvailability` now auto-populate `network` from the client's internal `activeNetwork` store when not explicitly provided. When `setNetwork("testnet")` is called via the UI toggle, all subsequent API calls automatically use the correct network.
...
- [`34f43b8`](https://github.com/elliotBraem/better-near-auth/commit/34f43b84574c324ef6f58a608f7861536e7675db) Thanks [@elliotBraem](https://github.com/elliotBraem)! - feat: sub-account creation v2 — configurable keys, deploy/init, hooks, rollback
