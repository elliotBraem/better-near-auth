              ...
              <Button variant="outline" size="sm" asChild className="flex items-center gap-2">
                ...
                >
                  <svg
                    ...
                    aria-label="GitHub"
                  >
                    <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.4 5.4 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65S8.93 17.78 9 18v4" />
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-full content-container">
            <div className="markdown-content">
              <ReactMarkdown
                ...
                components={{
                  h1: ({ children }) => (
                    <h1 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold mt-4 sm:mt-6 lg:mt-8 mb-2 sm:mb-3 lg:mb-4 first:mt-0">
                      {children}
                    </h1>
                  ),
                  h2: ({ children }) => (
                    <h2 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-semibold mt-4 sm:mt-6 lg:mt-8 mb-2 sm:mb-3 lg:mb-4">
                      {children}
                    </h2>
                  ),
                  h3: ({ children }) => (
                    <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-medium mt-3 sm:mt-4 lg:mt-6 mb-1.5 sm:mb-2 lg:mb-3">
                      {children}
                    </h3>
                  ),
                  p: ({ children }) => (
                    <p className="mb-2 sm:mb-3 lg:mb-4 leading-5 sm:leading-6 lg:leading-7 text-xs sm:text-sm lg:text-base">
                      {children}
                    </p>
                  ),
                  ...
                  ul: ({ children }) => (
                    <ul className="list-disc list-inside mb-2 sm:mb-3 lg:mb-4 space-y-0.5 sm:space-y-1 text-xs sm:text-sm lg:text-base pl-2">
                      {children}
                    </ul>
                  ),
                  ol: ({ children }) => (
                    <ol className="list-decimal list-inside mb-2 sm:mb-3 lg:mb-4 space-y-0.5 sm:space-y-1 text-xs sm:text-sm lg:text-base pl-2">
                      {children}
                    </ol>
                  ),
                  blockquote: ({ children }) => (
