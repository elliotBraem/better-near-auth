...
--> statement-breakpoint
CREATE INDEX `relayedTransaction_txHash_idx` ON `relayed_transaction` (`tx_hash`);--> statement-breakpoint
CREATE INDEX `relayedTransaction_userId_idx` ON `relayed_transaction` (`user_id`);--> statement-breakpoint
